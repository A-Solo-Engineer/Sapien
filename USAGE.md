...
of what is broken and what is unknown.

**Read the introductory article:**
[Sapien on dev.to](https://dev.to/admin-forestritium/sapien-teaching-ai-to-think-like-humans-instead-of-predicting-patterns-5nd)

**Contribute to the research:**
See [CONTRIBUTING.md](CONTRIBUTING.md) for how to contribute
theoretical work, architecture refinements, or research references.

**Join the discussion:**
[Forestritium Discord](https://discord.gg/Q64wr956)
...
Phase 3 — Evaluation Framework
  Metrics for epistemic closure
  Curiosity reward measurement
  Cross-generational drift detection

Phase 4 — Community Research
  Open collaboration on open problems
...
When Sapien moves to Phase 2, this document will be updated
with installation instructions, dependencies, and usage examples.

If you want to be notified when implementation begins:
- Watch the GitHub repository
- Join the Forestritium Discord
- Follow on Ark STEM: A Solo Engineer
